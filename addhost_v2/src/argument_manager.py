import argparse
# from .argument_exception import LineNumArgumentException
...
class ArgumentManager(object):
    ...
    def create_argument_parser(self):
        self.parser = argparse.ArgumentParser(
            ...
            epilog="如何使用命令参数： \
	        addhosts -f <filename> ,\
	        addhosts -f <filename> [-t excel] [-n <linenum>] [-a ipaddrcolumn] [-h hostcolumn] [-b <bakeupname>] [-u true|false] [-s {asc|desc|none}] , \
	        addhosts -f <filename> [-t text [-d <delimiter>] [-n <linenum>] [-a ipaddrcolumn] [-h hostcolumn] [-b <bakeupname>] [-u {update|ignore|terminate}] [-s {asc|desc|none}] , \
	        addhosts -v|? "
        )
